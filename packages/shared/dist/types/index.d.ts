...
export type RequirementStatus = 'PENDING' | 'VERIFIED' | 'REJECTED' | 'FULFILLED';
...
export type TimelineStage = 'REQUIREMENT_VERIFIED' | 'MATCHED' | 'PICKED_UP' | 'IN_TRANSIT' | 'DELIVERED' | 'CONFIRMED';
