...
export interface ScoringResult {
  ...
  isApproved: boolean; // >= 70 score qualifies for verified listing
...
export class RequirementScorer {
  ...
  public static evaluateRequirement(
    ...
    recentRequirementsCount: number = 0
  ): ScoringResult {
    let score = 100;
    ...
    else if (finalScore < 75) riskLevel = 'MEDIUM';
   ...
   */
  public static evaluateDeliveryAnomalies(
    pickupTime: string,
    deliveryTime: string,
    distanceKm: number
  ): RiskFlag[] {
