 ...
 */
export async function initSqlSchema(db: Knex): Promise<void> {
  // 1. Users table
...
export function institutionToRow(i: Institution): any {
  return {
    id: i.id,
    name: i.name,
...
export function rowToInstitution(r: any): Institution {
  return {
    id: r.id,
    name: r.name,
...
export function requirementToRow(req: Requirement): any {
  return {
    id: req.id,
...
export function rowToRequirement(r: any): Requirement {
  return {
    id: r.id,
...
export function donationToRow(d: Donation): any {
  return {
    id: d.id,
    donor_id: d.donorId,
...
export function announcementToRow(a: Announcement): any {
  return {
    id: a.id,
    title: a.title,
    message: a.message,
...
export function riskFlagToRow(f: RiskFlag): any {
  return {
    rule_id: f.ruleId,
...
export function rowToRiskFlag(r: any): RiskFlag {
  return {
    ruleId: r.rule_id,
...
export function telemetryToRow(t: TransitTelemetry): any {
  return {
...
export function rowToTelemetry(r: any): TransitTelemetry {
  return {
